...
var file_proto_v1_users_proto_rawDesc = string([]byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x75, 0x0a, 0x11, 0x41, 0x75,
	...
	0x09, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61,
	...
	0x0a, 0x11, 0x52, 0x65, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x44, 0x0a, 0x12, 0x52, 0x65, 0x76,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x22, 0x2d, 0x0a, 0x12,
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x9e, 0x02, 0x0a, 0x11, 0x50, 0x75, 0x62,
...
var file_proto_v1_users_proto_goTypes = []any{
	(*AuthorizeRequest)(nil),       // 0: users.v1.AuthorizeRequest
	(*AuthorizeResponse)(nil),      // 1: users.v1.AuthorizeResponse
	(*LogoutRequest)(nil),          // 2: users.v1.LogoutRequest
	(*LogoutResponse)(nil),         // 3: users.v1.LogoutResponse
	(*RevalidateRequest)(nil),      // 4: users.v1.RevalidateRequest
	(*RevalidateResponse)(nil),     // 5: users.v1.RevalidateResponse
	(*RegisterRequest)(nil),        // 6: users.v1.RegisterRequest
	(*RegisterResponse)(nil),       // 7: users.v1.RegisterResponse
	(*LoginRequest)(nil),           // 8: users.v1.LoginRequest
	(*LoginResponse)(nil),          // 9: users.v1.LoginResponse
	(*GetProfileRequest)(nil),      // 10: users.v1.GetProfileRequest
	(*GetProfileResponse)(nil),     // 11: users.v1.GetProfileResponse
	(*AssignAdminRequest)(nil),     // 12: users.v1.AssignAdminRequest
	(*AssignAdminResponse)(nil),    // 13: users.v1.AssignAdminResponse
	(*CreateEmployeeRequest)(nil),  // 14: users.v1.CreateEmployeeRequest
	(*CreateEmployeeResponse)(nil), // 15: users.v1.CreateEmployeeResponse
	(*BanUserRequest)(nil),         // 16: users.v1.BanUserRequest
	(*BanUserResponse)(nil),        // 17: users.v1.BanUserResponse
}
var file_proto_v1_users_proto_depIdxs = []int32{
	6,  // 0: users.v1.PublicUserService.Register:input_type -> users.v1.RegisterRequest
	8,  // 1: users.v1.PublicUserService.Login:input_type -> users.v1.LoginRequest
	2,  // 2: users.v1.PublicUserService.Logout:input_type -> users.v1.LogoutRequest
	4,  // 3: users.v1.PublicUserService.Revalidate:input_type -> users.v1.RevalidateRequest
	10, // 4: users.v1.InternalUserService.GetProfile:input_type -> users.v1.GetProfileRequest
	12, // 5: users.v1.InternalUserService.AssignAdmin:input_type -> users.v1.AssignAdminRequest
	14, // 6: users.v1.InternalUserService.CreateEmployee:input_type -> users.v1.CreateEmployeeRequest
	16, // 7: users.v1.InternalUserService.BanUser:input_type -> users.v1.BanUserRequest
	0,  // 8: users.v1.InternalUserService.Authorize:input_type -> users.v1.AuthorizeRequest
	7,  // 9: users.v1.PublicUserService.Register:output_type -> users.v1.RegisterResponse
	9,  // 10: users.v1.PublicUserService.Login:output_type -> users.v1.LoginResponse
	3,  // 11: users.v1.PublicUserService.Logout:output_type -> users.v1.LogoutResponse
	5,  // 12: users.v1.PublicUserService.Revalidate:output_type -> users.v1.RevalidateResponse
	11, // 13: users.v1.InternalUserService.GetProfile:output_type -> users.v1.GetProfileResponse
	13, // 14: users.v1.InternalUserService.AssignAdmin:output_type -> users.v1.AssignAdminResponse
	15, // 15: users.v1.InternalUserService.CreateEmployee:output_type -> users.v1.CreateEmployeeResponse
	17, // 16: users.v1.InternalUserService.BanUser:output_type -> users.v1.BanUserResponse
	1,  // 17: users.v1.InternalUserService.Authorize:output_type -> users.v1.AuthorizeResponse
